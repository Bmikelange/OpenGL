...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/mesh_viewer
  TARGETDIR  = bin
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/mesh_viewer
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/mesh_viewer
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/mesh_viewer
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/mesh_viewer
  DEFINES   += -DDEBUG
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/mesh_viewer
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/mesh_viewer
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
OBJECTS := \
	...
	$(OBJDIR)/mesh_buffer.o \
	$(OBJDIR)/mesh_data.o \
	$(OBJDIR)/material_data.o \
...
$(OBJDIR)/envmap.o: src/gKit/envmap.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/mesh_viewer.o: tutos/mesh_viewer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/mesh_buffer.o: tutos/mesh_buffer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/mesh_data.o: tutos/mesh_data.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/material_data.o: tutos/material_data.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
